...
<li class="zgw_upload_setting field_setting">
	...
	<small><?php esc_html_e('Gebruik het ID van een formulierveld om de waarde daarvan te gebruiken (bijv. [id]) in de beschrijving van het bestand.', config('core.text_domain')); ?></small>
</li>
