...
?>
<li class="zaak-process-steps__step <?php echo $vars['step']['isChecked'] ? 'zaak-process-steps__step--is-checked' : ''; ?>" aria-current="">
    ...
    <?php if ($vars['step']['substeps']) : ?>
        <ol class="zaak-process-steps__sub-step-list">
            <?php foreach ($step['substeps'] as $substep) : ?>
                <li class="zaak-process-steps__sub-step">
                    <div class="zaak-process-steps__sub-step-marker"></div>
                    <p class="zaak-process-steps__sub-step-heading"><?php echo $substep['title']; ?></p>
                </li>
            <?php endforeach; ?>
        </ol>
    <?php endif; ?>
