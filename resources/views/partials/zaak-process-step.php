...
?>
<li class="zaak-process-steps__step <?php echo $vars['isCurrent'] ? 'zaak-process-steps__step--current' : ''; echo $vars['isPast'] ? 'zaak-process-steps__step--past' : ''; ?>" aria-current="">
